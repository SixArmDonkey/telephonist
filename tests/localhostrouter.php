...
$router = new DefaultHTTPRouter(( new DefaultRouteFactory())
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ...
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' ) ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ...
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/users', fn() => 'Hello World' )
  ->add( '/fastroute/user/(?<id>\d+)', fn() => 'Hello World' )
  ->add( '/fastroute/articles', fn() => 'Hello World' )
  ->add( '/fastroute/articles/(?<id>\d+)/(?<title>[a-z]+)', fn( int $id, string $title ) => 'Hello World' ),
new DefaultHTTPRouteOptions(
  new MethodRouteOption( MethodRouteOption::GET ),
  new XMLHTTPRequestRouteOption()
));
